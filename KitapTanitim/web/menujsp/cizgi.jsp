...
<title>Cizgi Kitapları</title>
</head>
<body background="cizgi.jpg">
    <center>
	<table id="mainTable" cellspacing="0" cellpadding="0">	
                    <td valign="top" >
                        <table width="100%" border="4" bgcolor="gray">
                            <tr heigth="20">
                                <th colspan="3"><h2><b>Çizgi-Roman Kitapları</b></h2> </th>
                            </tr>
                                <%                    
                                  ...
                                  ResultSet reader = komut.executeQuery("Select id, ad, yazar, ozet from cizgi");
                                  while(reader.next()){
