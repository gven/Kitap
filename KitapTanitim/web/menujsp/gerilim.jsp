...
<title>Gerilim Kitapları</title>
</head>
<body background="gerilim.jpg">
    <center>
	<table id="mainTable" cellspacing="0" cellpadding="0">	
                    <td valign="top" >
                        <table  width="100%" border="4" bgcolor="gray">
                            <tr heigth="20">
                                <th colspan="3"><h2><b>Gerilim Kitapları</b></h2> </th>
                            </tr>
                                <%                    
                                  ...
                                  ResultSet reader = komut.executeQuery("Select id, ad, yazar, ozet from gerilim");
                                  while(reader.next()){
