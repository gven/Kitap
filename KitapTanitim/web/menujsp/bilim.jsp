...
<title>Bilimsel Kitaplar</title>
</head>
<body background="kurgu.jpg">
    <center>
	<table id="mainTable" cellspacing="0" cellpadding="0">	
                    <td valign="top" >
                        <table width="100%" border="4" bgcolor="gray">
                            <tr heigth="20">
                                <th colspan="3"><h2><b>Bilimsel Kitaplar</b></h2> </th>
                            </tr>
                                <%                    
                                  ...
                                  ResultSet reader = komut.executeQuery("Select id, ad, yazar, ozet from bilimsel");
                                  while(reader.next()){
                                ...
                                <tr heigth="80">
                                     <td width="250">
                                      ...
                                      <td width="250">                                           
                                         <a href="http://tr.wikipedia.org/wiki/<%= reader.getInt("id")%>">
